...
public class EventChooserFragment extends Fragment implements RecyclerClickListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        tabs = new ArrayList<>();
        tabs.add(new EventChooserSet("Technical Events", R.drawable.technical));
        tabs.add(new EventChooserSet("Sciences", R.drawable.sciences));
        tabs.add(new EventChooserSet("Workshops", R.drawable.workshops));
        tabs.add(new EventChooserSet("Others", R.drawable.others));
        tabs.add(new EventChooserSet("Initiatives", R.drawable.initiatives));
